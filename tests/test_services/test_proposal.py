...
@pytest.mark.parametrize(
    ...
    [
        ("create", ProposalType.CODE_PR, (), {"parent_rid": "repo", "title": "T", "source_ref": "feature"}, ProposalAction.CREATE),
        ...
        ("request_changes", ProposalType.CODE_PR, ("1",), {}, ProposalAction.REQUEST_CHANGES),
        ("merge", ProposalType.CODE_PR, ("1",), {}, ProposalAction.MERGE),
        ("close", ProposalType.CODE_PR, ("1",), {}, ProposalAction.CLOSE),
        ("create", ProposalType.GLOBAL_PROPOSAL, (), {"parent_rid": "ontology", "title": "T", "source_ref": "branch"}, ProposalAction.CREATE),
        ("list", ProposalType.GLOBAL_PROPOSAL, (), {"parent_rid": "ontology"}, ProposalAction.LIST),
        ("get", ProposalType.GLOBAL_PROPOSAL, ("gp",), {}, ProposalAction.GET),
        ("comment", ProposalType.GLOBAL_PROPOSAL, ("gp", "note"), {}, ProposalAction.COMMENT),
        ("approve", ProposalType.GLOBAL_PROPOSAL, ("gp",), {}, ProposalAction.APPROVE),
        ("request_changes", ProposalType.GLOBAL_PROPOSAL, ("gp",), {}, ProposalAction.REQUEST_CHANGES),
...
def test_every_unreachable_operation_fails_before_client_access(
    ...
    service.auth_manager.get_client = Mock(side_effect=AssertionError("client accessed"))
...
@pytest.mark.parametrize(
    ("error", "expected_type"),
    [
        (type("UnauthorizedError", (Exception,), {})("no token"), ProposalAuthenticationError),
